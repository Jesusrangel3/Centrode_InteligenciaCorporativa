    ...
    <div className="container mx-auto px-4 py-6 space-y-6 max-w-[1400px]">
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          {/* DRIVER SAFETY PODIUM */}
          <section className="space-y-4">
            <div className="flex items-center gap-2 border-b pb-2">
              <div className="h-4 w-1 bg-primary rounded-full" />
              <h3 className="text-xs font-bold uppercase tracking-wider text-primary flex items-center gap-1.5">
                <Award className="h-4 w-4 text-gold" /> Podio y Ranking de Seguridad de Operadores (Samsara Telemetry)
              </h3>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <Card className="lg:col-span-1 shadow-sm bg-gradient-to-br from-slate-900/90 to-slate-950/90 border border-border/30 p-5 flex flex-col justify-between min-h-[380px] relative overflow-hidden text-white">
                ...
                {/* Visual Podium */}
                {(() => {
                  // Get top 3 active tractos sorted by safety (ascending scoreSeguridad since lower is better, but filter out 0 or nulls)
                  const sortedSafety = [...filteredTractos]
                    .filter(t => t.estado === "Activo" && t.scoreSeguridad > 0)
                  ...
                  return (
                    <div className="flex items-end justify-center gap-2 mt-8 mb-4 h-36">
                      ...
                      {bronze && (
                        <div className="flex flex-col items-center flex-1">
                          <div className="text-[9px] text-center w-full truncate font-bold text-amber-650" title={bronze.conductor}>
